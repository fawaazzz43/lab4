...
class run
{
    ...
    {
        String file_CP = "D:\\programming\\java\\lab4\\src\\CustomersProducts.txt";
        String file_P = "D:\\programming\\java\\lab4\\src\\Products.txt";
        String file_E = "D:\\programming\\java\\lab4\\src\\Employee.txt";
        ...
        switch(me)
        {
            case 1 : {
                ...
                Adminrole A = new Adminrole(file_E);
            ...
            case 2 :
            {
                    ...
                    ProductDatabase P = new ProductDatabase(file_P) ;
                    CustomerProductDatabase C = new CustomerProductDatabase(file_CP) ;
